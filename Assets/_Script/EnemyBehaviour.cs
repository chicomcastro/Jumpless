...
public class EnemyBehaviour : MonoBehaviour {
	...
	void Start ()
	{
		...
		if (player == null)
		{
			player = Camera.main.gameObject.GetComponent<UnityStandardAssets._2D.CameraFollow>().m_Player.gameObject;

			if (player == null)
			{
				player = Camera.main.gameObject.GetComponent<UnityStandardAssets._2D.Camera2DFollow>().target.gameObject;
			}
		}
